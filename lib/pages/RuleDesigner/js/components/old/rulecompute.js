...
(function () {
  this.RuleCompute = function (rd, props) {
    ...
    this.expressionArguments = props.expressionArguments
    this.expressionResult = props.expressionResult
  ...
  for (var i in this.Activity.prototype) {
    this.RuleCompute.prototype[i] = this.Activity.prototype[i]
  }

  //通过JSON初始化
  this.RuleCompute.initByJson = function (json) {
